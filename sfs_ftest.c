 ...
 * reduce this value.
 */
#define MAX_BYTES 1000 /* Maximum file size I'll try to create */
#define MIN_BYTES 500         /* Minimum file size */
...
main(int argc, char **argv)
{
	...
	for (i = 0; i < nopen; i++) {
		int length_of_string = strlen(test_str);
		sfs_fwrite(fds[i], test_str, length_of_string);
		sfs_fclose(fds[i]);
	}
